...
public abstract class AFilter {
    ...
    protected final void createProgram(String vertex, String fragment) {
        ...
        mHCoord = GLES20.glGetAttribLocation(mProgram, "aTexCoord");
        mHMatrix = GLES20.glGetUniformLocation(mProgram, "vMatrix");
        mHTexture = GLES20.glGetUniformLocation(mProgram, "vTexture");
    }

    protected final void createProgramByAssetsFile(int vertexRs, int fraRes) {
        createProgram(ShaderUtils.readRawTextFile(mRes, vertexRs), ShaderUtils.readRawTextFile(mRes, fraRes));
    }
