...
public class HorizontalBlurFilter extends OESFilter {
    ...
    public void onCreateProgram(Context context) {
        ...
        String fragmentShader = ShaderUtils.readRawTextFile(context, R.raw.blur_horizontal_fragment_sharder);
