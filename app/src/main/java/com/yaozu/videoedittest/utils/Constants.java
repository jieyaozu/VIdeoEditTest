package com.yaozu.videoedittest.utils;

import android.content.Context;
import android.os.Environment;
import android.util.DisplayMetrics;

import com.yaozu.videoedittest.MyApplication;
...
public class Constants {
    ...
    public static String getBaseFolder() {
        String baseFolder = Environment.getExternalStorageDirectory() + "/VideoEditTest/";
